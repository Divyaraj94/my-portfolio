...
const projects = [
    ...
    {
    id: 1,
    title: "Jarvis (Multimodel Agent)",
    description: "J.A.R.V.I.S. 2.0 (DC Edition): An advanced, hardware-accelerated desktop HUD and fully autonomous multimodal AI companion engineered in Python and PyQt6, low-latency event loop to execute real-time system telemetry, local vector-cache RAG document indexing, and AI-driven operating system automation.",
    image: "/project3.png",
    liveUrl: "...",
    githubUrl: "...",
    tags: ["Python", "PyQt6","Gemini Live API","Playwright","WebSockets"],
    category: "AI", // ✅ Added
  },
  {
    id: 2,
    ...
    {filteredProjects.map((project) => {
      return (
        ...
        <motion.div
          ...
          // Added backdrop-blur-md and made the background slightly transparent (/70)
          className="bg-gray-900/70 backdrop-blur-md rounded-2xl border border-gray-700 shadow-lg overflow-hidden hover:shadow-purple-500/50 transition-shadow"
        >
          <img
            src={project.image}
